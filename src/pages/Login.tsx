    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-md space-y-8 animate-fade-in">
        ...
        <div className="glass-card rounded-2xl p-8 space-y-5">
          ...
          <div className="space-y-4">
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input placeholder="seu@email.com" className="pl-9 bg-muted/50 border-border/50" />
              </div>
            </div>
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input type={showPassword ? 'text' : 'password'} placeholder="••••••••" className="pl-9 pr-10 bg-muted/50 border-border/50" />
          ...
          <Button className="w-full h-11 glow-primary" onClick={() => navigate('/dashboard')}>
            Entrar
          </Button>
        ...
        <p className="text-center text-sm text-muted-foreground">
          Não tem conta? <button onClick={() => navigate('/register')} className="text-primary hover:underline font-medium">Criar conta grátis</button>
        </p>
      </div>
    </div>
  );
